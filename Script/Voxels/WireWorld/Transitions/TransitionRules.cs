...
public static class TransitionRules
{
  ...
  private static Cell[] Wires =>
    new[] { Wire, WireDecay1, WireDecay2, WireDecay3, WireDecay4 };

  private static Cell[] RedHeads =>
    new[] { RedHead, RedHeadDecay1, RedHeadDecay2, RedHeadDecay3, RedHeadDecay4 };

  private static Cell[] RedTails =>
    new[] { RedTail, RedTailDecay1, RedTailDecay2, RedTailDecay3, RedTailDecay4 };
  ...
  private static ImmutableDictionary<byte, WireWorldTransition[]> GenerateTransitions()
  {
    ...
    returned.Add(new WireWorldTransition(Always, ClosedWindow, Glass, static _ => WireWorldController.Step % 9 == 0));
    returned.Add(new WireWorldTransition(Always, Glass, ClosedWindow, AlwaysOdds));
  ...
  {
    Func<double, bool> func1 = static v => WireWorldController.Step % 20 == 0 && v < 0.5;
    Func<double, bool> func2 = static v => WireWorldController.Step % 40 == 0 && v < 0.5;
    Func<double, bool> func3 = static v => WireWorldController.Step % 60 == 0 && v < 0.5;
  ...
  {
    yield return new WireWorldTransition(new Rule[] { new(RedHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(GreenHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(BlueHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(CyanHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(MagentaHeads[headIndex], 1, 2) }, Lamp1, Lamp2,
      AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(YellowHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(WhiteHeads[headIndex], 1, 2) }, Lamp1, Lamp2, AlwaysOdds);

    yield return new WireWorldTransition(new Rule[] { new(RedHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(GreenHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(BlueHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(CyanHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(MagentaHeads[headIndex], 1, 2) }, Lamp2, Lamp3,
      AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(YellowHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(WhiteHeads[headIndex], 1, 2) }, Lamp2, Lamp3, AlwaysOdds);

    yield return new WireWorldTransition(new Rule[] { new(RedHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(GreenHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(BlueHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(CyanHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(MagentaHeads[headIndex], 1, 2) }, Lamp3, Lamp4,
      AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(YellowHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
    yield return new WireWorldTransition(new Rule[] { new(WhiteHeads[headIndex], 1, 2) }, Lamp3, Lamp4, AlwaysOdds);
  }

  private static IEnumerable<WireWorldTransition> Spread()
  {
    Func<double, bool> t1Spread = static v => v < 0.005;
    Func<double, bool> t2Spread = static v => v < 0.01;
    Func<double, bool> t3Spread = static v => v < 0.05;
  ...
  {
    Func<double, bool> t1Spread = static v => v < 0.01;
