...
{
    [Signal]
    public delegate void SplashScreensCompletedEventHandler(double value);
    ...
    private async Task Fade(TextureRect splash, float from, float to, float phaseDuration)
    {
        var elapsedTime = 0.0;
